...
#define __eth_stm32_desc __aligned(32)
#define __eth_stm32_buf  __aligned(32)
...
#if DT_HAS_COMPAT_STATUS_OKAY(st_stm32n6_ethernet)
	ETH_DMADescTypeDef rx_desc[ETH_DMA_RX_CH_CNT][ETH_RXBUFNB];
	ETH_DMADescTypeDef tx_desc[ETH_DMA_TX_CH_CNT][ETH_TXBUFNB];
#else
